                      ...
                      <div class="h-full max-w-full max-h-full mt-10 transition-all opacity-0 hs-overlay-open:mt-0 hs-overlay-open:opacity-100 hs-overlay-open:duration-500">
                          <div class="flex flex-col h-full max-w-full max-h-full bg-white pointer-events-auto dark:bg-neutral-800">
                              <div class="flex items-center justify-between px-4 py-3 border-b dark:border-neutral-700">
                                  ...
                                  <button type="button" class="inline-flex items-center justify-center text-gray-800 bg-gray-100 border border-transparent rounded-full size-8 gap-x-2 hover:bg-gray-200 focus:outline-none focus:bg-gray-200 dark:bg-neutral-700 dark:hover:bg-neutral-600 dark:text-neutral-400" aria-label="Close" data-hs-overlay="#hs-full-screen-modal">
                                      <span class="sr-only">Close</span>
                                      <svg class="shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                          <path d="M18 6 6 18"></path>
                                          <path d="m6 6 12 12"></path>
                              ...
                              <div class="grid h-full grid-cols-2 gap-6 p-6 overflow-y-auto">
                                  <!-- Title -->
                                  <div class="pb-6">
                                      <label for="title" class="block mb-2 font-medium text-gray-800 dark:text-white">Title</label>
                                      <input type="text" id="title" name="title" class="w-full px-4 py-3 border rounded-lg" placeholder="Recipe title" value="{{ old('title') }}" required>
                                      @error('title')
                                  ...
                                  <!-- Paragraph -->
                                  <div class="pb-6">
                                      <label for="paragraph" class="block mb-2 font-medium text-gray-800 dark:text-white">Content</label>
                                      <textarea id="paragraph" name="paragraph" class="block w-full px-4 py-3 border rounded-lg" rows="6" placeholder="Write your content..." required>{{ old('paragraph') }}</textarea>
                                      @error('paragraph')
                                      <p class="text-sm text-red-500">{{ $message }}</p>
                                      @enderror
                                  </div>
                                  ...
                                  <!-- Image Upload -->
                                  <div>
                                      <label for="image" class="block mb-2 font-medium text-gray-800 dark:text-white">Upload Image</label>
                                      <input type="file" id="image" name="image" class="block w-full text-gray-800 dark:text-white" accept="image/*">
                                      @error('image')
                                      <p class="text-sm text-red-500">{{ $message }}</p>
                                      @enderror
                                  </div>
                              ...
                              <div class="flex items-center justify-end px-4 py-3 mt-auto border-t gap-x-2 dark:border-neutral-700">
                                  <button type="button" class="inline-flex items-center px-3 py-2 text-sm font-medium text-gray-800 bg-white border border-gray-200 rounded-lg shadow-sm gap-x-2 hover:bg-gray-50 dark:bg-neutral-800 dark:border-neutral-700 dark:text-white" data-hs-overlay="#hs-full-screen-modal">
                                      Close
                                  </button>
                                  <button type="submit" name="save" class="bg-blue-500 hover:bg-blue-600 text-white py-2 px-4 rounded-md">Post</button>
                              </div>
                          </div>
                      </div>
                  </div>
