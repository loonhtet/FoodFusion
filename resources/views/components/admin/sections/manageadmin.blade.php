<main class="ms-0 lg:ms-64 p-6">
  ...
  <div class="w-full flex items-center justify-between">
    <h1 class="text-2xl font-bold mb-12">Manage Admin</h1>

    <form method="GET" action="{{ route('admin.dashboard.manageadmin') }}" class="flex">
      <input type="text" 
             name="search" 
    ...
    <a href="#" class="px-4 py-2 bg-green-500 text-white rounded hover:bg-green-600">New Admin</a>
  </div>
